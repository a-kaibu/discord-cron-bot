...
- workflow ファイルは [run.yml](/home/kota/prj/discord-cron-bot/.github/workflows/run.yml) です

### 手動実行

`Run workflow` から `message_keys` を指定すると、そのキーを日付に関係なく送信します。
